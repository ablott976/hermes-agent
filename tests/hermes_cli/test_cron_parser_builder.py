...
def test_cron_create_options():
    ...
    ns = parser.parse_args([
        ...
        "--workdir", "/tmp/x", "--session-mode", "persistent",
    ])
    ...
    assert ns.session_mode == "persistent"
...
def test_cron_edit_no_agent_tristate():
    ...
    assert parser.parse_args(
        ["cron", "edit", "j", "--session-mode", "persistent"]
    ).session_mode == "persistent"
    assert parser.parse_args(["cron", "edit", "j"]).session_mode is None

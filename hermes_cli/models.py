...
def _xai_promote_top(ids: list[str]) -> list[str]:
    ...
    The models.dev disk cache may predate a newly curated headline model. Keep
    the picker stable across stale/offline caches by inserting it when absent,
    not only by reordering it when present.
    """

...
AUTHOR_MAP = {
    ...
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # local integration history alias
    "ablott@gmail.com": "ablott976",  # local integration history
    "arturoblottescalera@Mac-mini-de-Arturo.local": "ablott976",  # local integration history
